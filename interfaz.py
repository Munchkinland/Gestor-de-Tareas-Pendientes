...
class Interfaz:
    def __init__(self, root):
        ...
        self.boton_mostrar = tk.Button(self.button_frame, text="Mostrar Tareas", command=self.mostrar_tareas, font=("Helvetica", 12), bg="#ff9800", fg="white", activebackground="#fb8c00", bd=0, padx=10, pady=5, relief="groove")
        self.boton_mostrar.pack(side=tk.LEFT, padx=5)
